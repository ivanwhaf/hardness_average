...
parser.add_argument('-project_name', type=str, help='project name', default='cifar10_pretrain_9cnn_data20000')
...
def create_dataloader():
    ...
    train_set, _ = torch.utils.data.random_split(train_set, [20000, 30000])
